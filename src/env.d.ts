...
type _CoercedEnvSchema_e8b9bcf3 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_e8b9bcf3> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_e8b9bcf3, 'NEXT_PUBLIC_SITE_URL'>> {}
}
...
type _EnvSchemaAsStrings_e8b9bcf3 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_e8b9bcf3 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_e8b9bcf3 {}
  }
}