...
type _CoercedEnvSchema_5a4c2227 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_5a4c2227> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_5a4c2227, 'GITHUB_CLIENT_ID' | 'NEXT_PUBLIC_SITE_URL'>> {}
}
...
type _EnvSchemaAsStrings_5a4c2227 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_5a4c2227 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_5a4c2227 {}
  }
}